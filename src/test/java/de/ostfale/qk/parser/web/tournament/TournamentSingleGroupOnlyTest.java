...
@Tag("unittest")
@DisplayName("Test tournament with only single group discipline without elimination")
public class TournamentSingleGroupOnlyTest extends BaseParserTest {

    private static final String TEST_FILE_NAME = "tournaments/TournamentSingleGroupOnly.html";
