...
class MatchResultAnalyzerTest {
    ...
    void testSingleStandardMatchLastWins() {
        ...
        assertAll("Test analyzed single match data",
                ...
                () -> assertThat(sut.getMatchMarkerPosition()).isEqualTo(expectedMarkerPosition),
                ...
                () -> assertThat(sut.getMatchMarker()).isEqualTo(expectedMarker),
    ...
    void testSingleSpecialWalkoverL() {
        // given
    ...
    void testSingleSpecialWalkoverLWithNumbersAfterName() {
        // given
    ...
    void testSingleMatchFirstRetiredInSecondSet() {
        // given
    ...
    void testSingleMatchSecondRetiredInSecondSet() {
        // given
