...
public interface WebDisciplineParser extends BaseParser {
    ...
    Map<String, DisciplineMapping> DISCIPLINE_SUB_HEADER_MAPPING = Map.<String, DisciplineMapping>ofEntries(
            ...
            Map.entry("DD A", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("DD B", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("DD C", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("DE", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("DE A", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("DE B/C", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("DE C", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("HE", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("HE A", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("HE B", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("HE C", new DisciplineMapping(SINGLE, UOX)),
            Map.entry("HD", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("HD A", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("HD B", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("HD C", new DisciplineMapping(DOUBLE, UOX)),
            Map.entry("MX", new DisciplineMapping(MIXED, UOX)),
            Map.entry("MX A", new DisciplineMapping(MIXED, UOX)),
            Map.entry("MX B", new DisciplineMapping(MIXED, UOX)),
            Map.entry("MX C", new DisciplineMapping(MIXED, UOX)),
